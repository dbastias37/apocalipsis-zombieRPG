    ...
    <div className="min-h-screen bg-gradient-to-b from-neutral-950 via-black to-neutral-950">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        {currentCard ? (
          ...
          <NoCardActions onExplore={exploreArea} onPassNight={passNight} phase={phase} explorationActive={explorationActive} openLore={()=>setShowLore(true)} />
        )}
...
function NoCardActions({onExplore, onPassNight, phase, explorationActive, openLore}:{onExplore:()=>void; onPassNight:()=>void; phase:Phase; explorationActive:boolean; openLore:()=>void}){
  return (
    <div className="card bg-neutral-900 border-neutral-800 p-6 flex flex-wrap items-center gap-3">
      ...
      <button className="px-4 py-2 rounded-lg border border-neutral-700 bg-neutral-800 hover:bg-neutral-700 text-sm" onClick={openLore} title="Abrir Historias">📖 Historias</button>
