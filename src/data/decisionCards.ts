...
// Cartas de DECISIÓN (moradas): 45 en total
export const decisionCards: DecisionCard[] = [
  ...
  },
  {
    ...
    choices: [
      { text: "Forzar botiquines", effect: { medicine: 4, morale: 1 } },
  ...
  {
    id: 246,
    title: "Cartel de vacunación",
    text:
      "Un gimnasio reconvertido en centro de vacunación. Hay mesas con jeringas, algodones y cajas vacías. Un cuarto frío cerrado con candado.",
    choices: [
      { text: "Forzar el cuarto frío", effect: { medicine: 3, zombies: 1 } },
      { text: "Recolectar suministros limpios", effect: { medicine: 2, materials: 1 } },
      { text: "Clasificar residuos médicos", effect: { karma: 3, morale: 1 } }
    ]
  },
  {
    id: 247,
    title: "El archivo parroquial",
    text:
      "Archivos con registros familiares. Entre papeles, recetas de remedios caseros. Un desván suena hueco al pisar.",
    choices: [
      { text: "Bajar cajas útiles", effect: { materials: 2, morale: 1 } },
      { text: "Revisar el desván", effect: { zombies: 1, medicine: 1, ammo: 1 } },
      { text: "Dejar instrucciones útiles", effect: { karma: 2 } }
    ]
  },
  {
    id: 248,
    title: "Sastrería con doble fondo",
    text:
      "Bajo el mostrador hay un doble fondo con rollos de tela resistentes y agujas industriales. Un maniquí enfrente da escalofríos.",
    choices: [
      { text: "Tomar materiales resistentes", effect: { materials: 4 } },
      { text: "Buscar escondites adicionales", effect: { ammo: 2, morale: 1 } },
      { text: "Dejar parches y patrones", effect: { karma: 3 } }
    ]
  },
  {
    id: 249,
    title: "La barbería",
    text:
      "Peines, toallas, navajas. Un sillón reclinable frente a un espejo roto. Un cajón cerrado con llave oxidada.",
    choices: [
      { text: "Forzar el cajón", effect: { materials: 1, ammo: 1 } },
      { text: "Tomar navajas útiles", effect: { materials: 2 } },
      { text: "Dejar cuerdas y ordenar", effect: { materials: -1, karma: 2 } }
    ]
  },
  {
    id: 250,
    ...
    text:
      "Un mirador domina el cauce donde flotan restos. Hay bancos de madera y una caseta con prismáticos. La corriente arrastra objetos.",
    choices: [
      { text: "Vigilar y trazar rutas", effect: { morale: 2, materials: 1 } },
      { text: "Intentar pescar algo útil", effect: { food: 2, zombies: 1 } },
      { text: "Dejar marcas de corrientes", effect: { karma: 2 } }
    ]
  },
  {
    id: 251,
    title: "La tienda de fotos",
    text:
      "Carretes expuestos, cámaras rotas y álbumes. Una caja fuerte pequeña con logo de marca antigua. El cuarto oscuro aún huele a químicos.",
    choices: [
      { text: "Forzar caja y tomar pilas", effect: { materials: 2, fuel: 1 } },
      { text: "Recuperar linternas y filtros", effect: { materials: 2 } },
      { text: "Dejar álbumes con notas útiles", effect: { karma: 3, morale: 1 } }
    ]
  },
  {
    id: 252,
    title: "Enfermería del estadio",
    text:
      "El estadio municipal guarda una enfermería con camillas. Un botiquín rojo cerrado con combinación. Restos de vendas por el suelo.",
    choices: [
      { text: "Forzar combinación", effect: { medicine: 3, zombies: 1 } },
      { text: "Tomar vendas y gasas", effect: { medicine: 2 } },
      { text: "Dejar señal clara de acceso", effect: { karma: 2 } }
    ]
  },
  {
    id: 253,
    ...
    text:
      "Una sala de clases con linternas gastadas y termos. En el pizarrón, un horario de evacuación. Un armario metálico con candado.",
    choices: [
      { text: "Forzar el armario", effect: { ammo: 2, materials: 1, zombies: 1 } },
      { text: "Tomar termos y linternas", effect: { materials: 2, water: 1 } },
      { text: "Reescribir el plan de evacuación", effect: { karma: 3, morale: 1 } }
    ]
  },
  {
    id: 254,
    title: "Terminal olvidada",
    text:
      "En una terminal de carga, un palé con cajas sin etiquetas. Una carretilla manual y correas. El candado del portón está oxidado.",
    choices: [
      { text: "Abrir cajas y repartir", effect: { food: 3, water: 2, materials: 1 } },
      { text: "Tomar carretilla y correas", effect: { materials: 3, morale: 1 } },
      { text: "Cerrar portón y dejar aviso", effect: { materials: -1, karma: 2 } }
    ]
  },
  {
    id: 255,
    title: "Notas en la nevera",
    text:
      "En una casa, la nevera tiene notas imantadas con recetas y rutas de escape garabateadas. Un armario bajo llave en la cocina.",
    choices: [
      { text: "Abrir el armario", effect: { food: 3, medicine: 1 } },
      { text: "Copiar rutas, no tocar nada", effect: { karma: 3, morale: 2 } },
      { text: "Dejar agua para otros", effect: { water: -2, karma: 2 } }
    ]
  }
];
