...
export default function ZombieRPGUltimate() {
  ...
  const [resources, setResources] = useState({ food: 15, water: 15, medicine: 8, fuel: 10, ammo: 30, materials: 10 });
...
const [combatDiscard, setCombatDiscard] = useState([]);
  ...
  // --- Datos del juego ---
  const professions = [
    { id: "doctor", name: "Médico", bonus: { Inteligencia: 3, medicine: 5 }, skill: "Curación avanzada" },
    { id: "soldier", name: "Soldado", bonus: { Fuerza: 3, Constitución: 2 }, skill: "Combate táctico" },
    { id: "engineer", name: "Ingeniero", bonus: { Inteligencia: 2, Destreza: 2 }, skill: "Construcción eficiente" },
    { id: "police", name: "Policía", bonus: { Destreza: 3, defensa: 2 }, skill: "Vigilancia nocturna" },
    { id: "hunter", name: "Cazador", bonus: { Destreza: 3, perception: 4 }, skill: "Rastreo y caza" },
    { id: "survivor", name: "Superviviente", bonus: { Constitución: 3, energía: 5 }, skill: "Adaptación rápida" },
    { id: "psychologist", name: "Psicólogo", bonus: { Carisma: 4, Inteligencia: 2 }, skill: "Mantener la moral" },
    { id: "athlete", name: "Atleta", bonus: { Fuerza: 2, Destreza: 3 }, skill: "Resistencia superior" },
    { id: "teacher", name: "Profesor", bonus: { Inteligencia: 3, Carisma: 2 }, skill: "Enseñanza y aprendizaje" },
    { id: "mechanic", name: "Mecánico", bonus: { Destreza: 2, Fuerza: 2 }, skill: "Reparación de vehículos" }
  ];
  ...
  const storyCards = [
    // Cartas filosóficas y profundas (50 total)
    {
      ...
      choices: [
        { text: "Cumplir su última voluntad", effect: { morale: -2, loot: 'bunker_key', karma: 5 } },
        { text: "Dejarlo a su destino", effect: { morale: -5, zombies: 1, karma: -3 } },
        { text: "Intentar salvarlo", effect: { medicine: -3, ally: 'priest', karma: 10 } }
      ],
      philosophy: "mercy"
    },
    {
    ...
    },
    {
      ...
      choices: [
        ...
        { text: "Proponer un intercambio justo", effect: { water: -2, food: 3, morale: 3 } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Usar medicina preciosa", effect: { medicine: -5, time_gained: true, morale: 5 } },
        { text: "Aislarlo humanamente", effect: { morale: -3, safety: true } },
        { text: "Tomar la decisión difícil", effect: { morale: -8, group_unity: true, karma: -5 } }
      ],
      philosophy: "identity"
    },
    {
      ...
      choices: [
        { text: "Revelar la verdad gradualmente", effect: { morale: -3, prepared_children: true } },
        { text: "Mantener la ilusión", effect: { morale: 5, vulnerable_children: true } },
        { text: "Dejar que otros decidan", effect: { group_conflict: true, morale: -2 } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Aceptar la protección", effect: { defense: 10, food: -5, moral_corruption: true } },
        { text: "Rechazar y fortificar", effect: { materials: -8, independence: true } },
        { text: "Negociar términos mejores", effect: { charisma_check: true, potential_alliance: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Guiarlos al exterior", effect: { morale: -5, new_perspective: true, zombies: 3 } },
        { text: "Respetar su realidad", effect: { philosophical_doubt: true } },
        { text: "Dejar evidencia sutil", effect: { gradual_awakening: true, morale: -2 } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Aceptar el liderazgo", effect: { leadership: true, stress: 10, respect: 5 } },
    ...
    },
    {
      ...
      choices: [
        { text: "Ejecutar por votación", effect: { group_satisfaction: true, moral_decline: true } },
        { text: "Exiliar sin recursos", effect: { morale: -3, clean_conscience: true } },
        { text: "Intentar rehabilitación", effect: { risk: true, potential_redemption: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Celebrar la humanidad", effect: { food: -8, morale: 15, unity: true } },
        { text: "Racionar estrictamente", effect: { food: -3, morale: -5, survival_days: 3 } },
        { text: "Decisión democrática", effect: { democracy: true, varied_outcome: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Ofrecer voluntarios", effect: { cure_progress: true, casualties: 'random', science: true } },
        { text: "Rechazar el riesgo", effect: { missed_opportunity: true, morale: -3 } },
        { text: "Negociar alternativas", effect: { AI_relationship: true, data_exchange: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Vadear el río", effect: { risk: 'high', potential_paradise: true, infection_risk: true } },
        { text: "Buscar otro camino", effect: { time: -1, energy: -5, safe_route: true } },
        { text: "Construir una balsa", effect: { materials: -10, creative_solution: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Preservar el conocimiento", effect: { cold_nights: true, morale: 8, culture: true } },
        { text: "Quemar por supervivencia", effect: { warmth: 10, morale: -10, cultural_loss: true } },
        { text: "Salvar libros selectos", effect: { warmth: 5, some_culture: true, compromise: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Confesar la infección", effect: { trust: true, medical_cooperation: 'possible' } },
        { text: "Ocultar la verdad", effect: { temporary_peace: true, future_conflict: true } },
        { text: "Proponer cuarentena mutua", effect: { cautious_alliance: true, time: -1 } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Lo seguro y lejano", effect: { energy: -10, guaranteed_shelter: true } },
        { text: "El riesgo cercano", effect: { energy: -3, uncertainty: true } },
        { text: "El sueño imposible", effect: { morale: 5, epic_journey: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Enfrentar la culpa", effect: { mental_health: true, morale: -3, wisdom: true } },
        { text: "Reprimir y continuar", effect: { stress: 5, efficiency: true } },
        { text: "Encontrar propósito", effect: { new_mission: true, morale: 5 } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Mantener vigilancia total", effect: { security: 10, trust: -5, control: true } },
        { text: "Limitar a perímetros", effect: { security: 5, privacy: true } },
        { text: "Rotación democrática", effect: { shared_responsibility: true, moderate_security: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Aceptar con condiciones", effect: { manpower: 5, ideological_conflict: true } },
        { text: "Rechazar por principios", effect: { morale: 3, enemies: true } },
        { text: "Período de prueba", effect: { temporary_alliance: true, future_decision: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Encontrar significado en la lucha", effect: { morale: 8, philosophical_strength: true } },
        { text: "Buscar solución permanente", effect: { innovation: true, materials: -15 } },
        { text: "Aceptar la futilidad", effect: { nihilism: true, efficiency: -3 } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Usar sus métodos", effect: { zombie_prediction: true, shallow_knowledge: true } },
        { text: "Buscar comprensión profunda", effect: { time: -2, true_understanding: 'possible' } },
        { text: "Documentar todo", effect: { knowledge_preserved: true, immediate_risk: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Aceptar su ayuda y pasado", effect: { complicated_ally: true, moral_flexibility: true } },
        { text: "Agradecimiento y distancia", effect: { clean_break: true, morale: -2 } },
        { text: "Ofrecer redención condicional", effect: { redemption_arc: true, group_tension: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Lotería justa", effect: { random_selection: true, morale: -5, fairness: true } },
        { text: "Selección utilitaria", effect: { optimal_survival: true, moral_cost: true } },
        { text: "Quedarse todos juntos", effect: { unity: true, missed_escape: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Estudiarlo humanamente", effect: { slow_research: true, morale: 3 } },
        { text: "Procedimientos completos", effect: { breakthrough_chance: true, morale: -8 } },
        { text: "Respetar sus deseos", effect: { missed_knowledge: true, humanity: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Suprimir la teoría", effect: { mental_stability: true, intellectual_dishonesty: true } },
        { text: "Discusión abierta", effect: { mental_stress: 5, intellectual_growth: true } },
        { text: "Canalizar hacia acción", effect: { research_boost: true, obsession_risk: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Intentar rescate", effect: { chaos: true, resources: 10, unstable_allies: true } },
        { text: "Tomar recursos y huir", effect: { supplies: 15, morale: -10, pragmatism: true } },
        { text: "Contacto gradual", effect: { time: -3, possible_integration: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Educación clásica", effect: { culture_preserved: true, practical_skills: -3 } },
        { text: "Supervivencia pura", effect: { survival_skills: 5, humanity_loss: true } },
        { text: "Balance pragmático", effect: { balanced_education: true, time: -2 } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Buscar la fuente", effect: { fuel: -5, mystery_solved: 'maybe', morale: 3 } },
        { text: "Ignorar y sobrevivir", effect: { pragmatic: true, eternal_doubt: true } },
        { text: "Enviar respuesta", effect: { exposure_risk: true, contact_chance: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Sistema voluntario", effect: { medical_efficiency: true, moral_complexity: true } },
        { text: "Prohibir rotundamente", effect: { deaths_preventable: true, moral_clarity: true } },
        { text: "Caso por caso", effect: { flexible_ethics: true, conflict_potential: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Protegerla a toda costa", effect: { hope: 10, resource_drain: true } },
        { text: "Estudiarla éticamente", effect: { research: true, child_stress: true } },
        { text: "Dejarla elegir", effect: { uncertain_future: true, moral_integrity: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Intentar comunicación", effect: { time: -1, understanding: 'gradual' } },
        { text: "Evitar contacto", effect: { missed_opportunity: true, safety: true } },
        { text: "Seguir sus señales", effect: { trust_leap: true, unknown_outcome: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Apoyar el teatro", effect: { morale: 10, resources: -3, culture: true } },
        { text: "Solo trabajo útil", effect: { efficiency: 5, morale: -5, soul_death: true } },
        { text: "Arte con condiciones", effect: { balanced_culture: true, compromise: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Implementar lotería", effect: { fairness: true, efficiency: -3, morale: 3 } },
        { text: "Asignación por habilidad", effect: { optimization: true, inequality: true } },
        { text: "Sistema mixto", effect: { complex_system: true, balance_attempt: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Mantener fortificaciones", effect: { security: 10, freedom: -5, labor_intensive: true } },
        { text: "Vida nómada", effect: { freedom: 10, danger: 10, mobility: true } },
        { text: "Defensas minimalistas", effect: { balanced_approach: true, moderate_risk: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Abrir con precauciones", effect: { knowledge: true, pandora_risk: true } },
        { text: "Sellar permanentemente", effect: { safety: true, ignorance: true } },
        { text: "Decisión futura", effect: { delayed_choice: true, ongoing_temptation: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Usar espejos", effect: { defense: 5, morale: -7, constant_reminder: true } },
        { text: "Evitar reflejos", effect: { psychological_comfort: true, tactical_disadvantage: true } },
        { text: "Uso selectivo", effect: { moderate_defense: true, controlled_exposure: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Aprender sus métodos", effect: { new_skills: true, vulnerability_period: true } },
        { text: "Intercambio de conocimientos", effect: { mutual_learning: true, time: -2 } },
        { text: "Observar solamente", effect: { limited_knowledge: true, safety: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Poder militar", effect: { weapons: 10, enemies: 'healers_and_scholars' } },
        { text: "Capacidad médica", effect: { medicine: 10, enemies: 'warriors_and_scholars' } },
        { text: "Sabiduría preservada", effect: { knowledge: 10, enemies: 'warriors_and_healers' } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Documentar todo", effect: { unique_knowledge: true, moral_cost: true } },
        { text: "Eutanasia compasiva", effect: { mercy: true, knowledge_lost: true } },
        { text: "Observación a distancia", effect: { partial_knowledge: true, safety: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Usarlo para el grupo", effect: { stealth_missions: true, hero_complex: true } },
        { text: "Compartir el secreto", effect: { group_capability: true, power_diluted: true } },
        { text: "Guardarlo para emergencias", effect: { secret_ace: true, moral_burden: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Consuelo teológico", effect: { mercy: true, philosophical_dishonesty: true } },
        { text: "Honestidad brutal", effect: { truth: true, suffering_increased: true } },
        { text: "Silencio respetuoso", effect: { dignity_preserved: true, question_unanswered: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Aceptar autoridad absoluta", effect: { winter_survival: true, freedom_lost: true } },
        { text: "Mantener democracia", effect: { inefficiency: true, moral_high_ground: true } },
        { text: "Autoridad temporal limitada", effect: { compromise: true, future_conflict: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Permitir la fantasía", effect: { happiness: true, reality_abandoned: true } },
        { text: "Destruir la tentación", effect: { harsh_reality: true, authenticity: true } },
        { text: "Uso terapéutico limitado", effect: { mental_health_tool: true, addiction_risk: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Seguir sus recuerdos", effect: { hope_journey: true, uncertain_path: true } },
        { text: "Hipnosis o drogas", effect: { memory_extraction: true, mental_damage: true } },
        { text: "Expedición de búsqueda", effect: { systematic_search: true, resource_drain: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Distribución aleatoria", effect: { five_saved: true, random_death: true } },
        { text: "Rechazar el juego", effect: { moral_stance: true, vaccines_lost: true } },
        { text: "Un voluntario prueba", effect: { heroic_sacrifice: true, certainty: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Enviar advertencia", effect: { temporal_paradox: true, existence_gamble: true } },
        { text: "Preservar la línea temporal", effect: { acceptance: true, guilt: true } },
        { text: "Mensaje críptico", effect: { minimal_change: true, butterfly_effect: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Permitir la música", effect: { morale: 12, zombie_attraction: true } },
        { text: "Prohibir todo ruido", effect: { safety: true, spiritual_death: true } },
        { text: "Música silenciosa", effect: { compromise_art: true, reduced_risk: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Salvar al niño", effect: { moral_integrity: true, three_deaths: true } },
        { text: "Salvar a los tres", effect: { utilitarian_choice: true, child_death: true } },
        { text: "Dejar que el doctor elija", effect: { medical_ethics: true, responsibility_shifted: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Honrar sus memorias", effect: { moral_continuity: true, living_burden: true } },
        { text: "Los vivos deciden", effect: { pragmatism: true, guilt: true } },
        { text: "Consejo de ancianos", effect: { wisdom_council: true, generational_bridge: true } }
      ],
    ...
    },
    {
      ...
      choices: [
        { text: "Rechazar la teoría", effect: { moral_stance: true, theory_untested: true } },
        { text: "Preparar para ser último", effect: { isolation_preparation: true, dark_path: true } },
        { text: "Buscar alternativas", effect: { research_focus: true, hope_maintained: true } }
      ],
      philosophy: "last_man"
    },
    {
      ...
      choices: [
        { text: "Sacrificio heroico", effect: { cure_created: true, player_death: true, legend: true } },
        { text: "Buscar otro camino", effect: { continued_search: true, moral_question: true } },
        { text: "Preparar sucesores", effect: { knowledge_transfer: true, delayed_cure: true } }
      ],
...
const combatCards = [
  {
    ...
    choices: [
      ...
      { text: 'Buscar cobertura (DEF +5 1 turno)', effect: { buff_defense: 5 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Granada improvisada (ammo -2, menos enemigos)', effect: { ammo: -2, zombies: 2 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'Sigilo (requiere Destreza, morale +2)', effect: { morale: 2 } },
      { text: 'Táctica de distracción (fuel -1, pasas turno)', effect: { fuel: -1, pass: true } }
    ]
  },
  {
    id: 'c4',
    ...
    choices: [
      { text: 'Peinar el área (3 enemigos, materiales +2 si ganas)', effect: { zombies: 3, materials: 2 } },
      { text: 'Evitar conflicto (morale -1)', effect: { morale: -1 } },
      { text: 'Colocar trampa (materials -2, próximos combates más fáciles)', effect: { materials: -2, trap: true } }
    ]
  }
];
...
const philosophyQuotes = {
  ...
  trolley_problem: '“El fin justifica los medios.” — Frase atribuida (discutida) a tradición utilitarista',
  justice_vs_revenge: '“Quien lucha con monstruos debe cuidar de no convertirse en uno.” — Nietzsche',
  social_contract: '“El hombre nace libre, y en todas partes está encadenado.” — Rousseau',
  problem_of_evil: '“O Dios quiere eliminar el mal y no puede, o puede y no quiere...” — Epicuro',
  chinese_room: '“Comprender no es solo manipular símbolos.” — Searle (paráfrasis)',
  experience_machine: '“¿Elegirías una vida de placer simulado?” — Nozick (paráfrasis)',
  identity: '“¿Qué nos hace ser los mismos?” — Paradoja de Teseo (alusión)',
  memory_reliability: '“La memoria es el escriba del alma.” — Aristóteles (atribuido)',
  prisoners_dilemma: '“La cooperación racional puede ser inestable.” — Teoría de juegos'
};
  ...
  function createPlayer(name, profession, isDemo = false) {
    const attrs = isDemo ? 
      { Fuerza: 14, Destreza: 13, Constitución: 15, Inteligencia: 12, Carisma: 11 } :
      { Fuerza: 10, Destreza: 10, Constitución: 10, Inteligencia: 10, Carisma: 10 };
  ...
  function saveGame() {
    const saveData = {
      players, activeIndex, round, day, time, resources, camp, morale, threat,
      usedCards, relationships, achievements, difficulty, log: log.slice(0, 20)
    };
  ...
  function loadGame() {
    ...
    if (saveData) {
      ...
      setResources(data.resources || { food: 15, water: 15, medicine: 8, fuel: 10, ammo: 30, materials: 10 });
    ...
    demoInterval.current = setInterval(() => {
      ...
      switch(step) {
        ...
        case 4:
          ...
          pushLog(`Marcus ataca: ${dmgRoll.natural} + ${dmgRoll.modifier} = ${dmgRoll.total} daño`, 'combat');
          break;
        case 5:
        ...
        case 7:
          ...
          setResources(prev => ({...prev, food: prev.food + 3, water: prev.water + 2}));
          break;
        case 8:
          advanceTime();
          ...
          break;
        case 9:
          pushLog("Sistema de relaciones: Sarah y Marcus mejoran su cooperación", 'moral');
          break;
        case 10:
          pushLog("=== DEMO COMPLETADA - TODOS LOS SISTEMAS FUNCIONAN ===", 'success');
          setDemoMode(false);
  ...
  function levelUp(playerIndex) {
    ...
    const mainAttr = ['Fuerza', 'Destreza', 'Constitución', 'Inteligencia', 'Carisma'][Math.floor(Math.random() * 5)];
  ...
  function unlockSkill(playerIndex) {
    const skills = [
      "Golpe crítico", "Esquiva mejorada", "Resistencia", "Liderazgo",
      "Supervivencia", "Medicina de campo", "Francotirador", "Sigilo"
    ];
  ...
  function startNewGame() {
    ...
    setLog([]);
    setEnemies([]);
    setResources({ food: 15, water: 15, medicine: 8, fuel: 10, ammo: 30, materials: 10 });
  ...
  function drawStoryCard() {
    const availableCards = storyCards.filter(card => !usedCards.includes(card.id));
    
    if (availableCards.length === 0) {
      setUsedCards([]);
      pushLog("Todas las historias han sido contadas. El ciclo comienza de nuevo...", 'story');
    ...
    if (card.philosophy) {
      ...
      setMorale(prev => Math.max(0, Math.min(100, prev + philosophicalImpact)));
    }
  }
    ...
    Object.entries(choice.effect).forEach(([key, value]) => {
      switch(key) {
        ...
        case 'morale':
          ...
          pushLog(`Moral ${value > 0 ? 'aumenta' : 'disminuye'}: ${value}`, 'moral');
          break;
        case 'karma':
          handleKarma(value);
          break;
  ...
  function handleSpecialEffect(effect, value) {
    ...
    const specialEffects = {
      'bunker_key': () => {
        ...
        setAchievements(prev => [...prev, { type: 'item', name: 'bunker_key' }]);
      },
      'cure_progress': () => {
      ...
      'philosophical_strength': () => {
        ...
        setPlayers(prev => prev.map(p => ({...p, cordura: Math.min(100, p.cordura + 10)})));
      }
    };
  ...
  function addNewSurvivors(count) {
    ...
    for (let i = 0; i < count; i++) {
      const name = names[Math.floor(Math.random() * names.length)] + " " + (players.length + i + 1);
      const profession = professions[Math.floor(Math.random() * professions.length)].id;
  ...
  function handleRandomCasualty() {
    if (players.length > 1) {
      ...
      updatePlayer(casualty, { estado: 'herido', pv: Math.floor(players[casualty].pv / 2) });
  ...
  function nextTurn() {
    const next = (activeIndex + 1) % players.filter(p => p.estado !== 'muerto').length;
    setActiveIndex(next);
    ...
    if (camp.comfort > 5) {
      updatePlayer(activeIndex, {
        energía: Math.min(players[activeIndex].energíaMax, players[activeIndex].energía + 1)
      });
    }
  ...
  function spawnEnemies(count) {
    const newEnemies = [];
    const difficultyModifier = difficulty === 'easy' ? 0.7 : difficulty === 'hard' ? 1.3 : 1;
    
    for (let i = 0; i < count; i++) {
      const type = enemyTypes[Math.floor(Math.random() * Math.min(enemyTypes.length, day / 10 + 2))];
      newEnemies.push({
        id: Math.random().toString(36).substr(2, 9),
        ...type,
    ...
    switch(action) {
      case 'attack':
        if (targetId && enemies.length > 0) {
          ...
          if (enemy) {
            const hasWeapon = actor.inventario.includes("Pistola") || actor.inventario.includes("Rifle");
            ...
            pushLog(`${actor.nombre} ataca a ${enemy.name}: ${attackRoll.total} vs DEF ${enemy.def}`, 'combat');
            ...
            if (hit) {
              ...
              if (enemy.currentHp <= 0) {
                ...
                setEnemies(prev => prev.map(e => 
                  e.id === targetId ? {...e, currentHp: enemy.currentHp} : e
                ));
              }
  ...
  function enemyAttack() {
    enemies.forEach(enemy => {
      const target = players.filter(p => p.estado !== 'muerto')[
        Math.floor(Math.random() * players.filter(p => p.estado !== 'muerto').length)
      ];
  ...
  function drawCombatCard() {
    ...
    const card = available.length > 0 ? available[Math.floor(Math.random()*available.length)] : combatCards[Math.floor(Math.random()*combatCards.length)];
  ...
  function handleCombatCardChoice(choice) {
    ...
    Object.entries(choice.effect).forEach(([key, value]) => {
      switch(key) {
        ...
        case 'water':
        case 'medicine':
          setResources(prev => ({ ...prev, [key]: Math.max(0, prev[key] + value) }));
          break;
        case 'morale':
          setMorale(prev => Math.max(0, Math.min(100, prev + value)));
          break;
    ...
    if (currentCombatCard) setCombatDiscard(prev => [...prev, currentCombatCard.id]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-950 via-black to-neutral-950 flex items-center justify-center">
        <div className="text-center animate-fade-in relative">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-6xl font-bold text-neutral-300 mb-4">
              RPG
            </h2>
            ...
            {demoMode ? (
              <div className="mb-8 p-6 bg-black/50 rounded-2xl border border-red-900 backdrop-blur">
                <p className="text-yellow-400 text-xl animate-pulse">🎮 Demo en progreso...</p>
                <p className="text-sm text-neutral-400 mt-2">Verificando todos los sistemas</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4 justify-center pt-4">
                  ...
                  >
                    ⚔️ Dificultad: {difficulty === 'easy' ? 'Fácil' : difficulty === 'hard' ? 'Difícil' : 'Normal'}
                  </button>
                  <button 
            ...
            {showCredits && (
              <div className="mt-8 p-4 bg-black/50 rounded-xl text-sm text-neutral-400">
                ...
                <p className="mb-2">50 cartas narrativas con dilemas filosóficos</p>
        ...
        <div className="bg-gradient-to-br from-neutral-900 to-black border-2 border-red-900 rounded-3xl p-8 max-w-md shadow-2xl">
          ...
          <div className="mb-6 p-4 bg-neutral-800/50 rounded-xl">
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div className="text-neutral-200 font-bold">{players.filter(p => p.estado !== 'muerto').length}/{players.length}</div>
  ...
  function GameHUD() {
    ...
    const dangerLevel = threat > 50 ? 'text-red-500' : threat > 25 ? 'text-yellow-500' : 'text-green-500';
        ...
        <div className="bg-gradient-to-b from-neutral-900/30 to-transparent">
          <div className="max-w-7xl mx-auto px-4 py-2">
            <div className="flex gap-2 overflow-x-auto scrollbar-hide">
              <TabButton active={tab === 'story'} onClick={() => setTab('story')}>📖 Historia</TabButton>
              <TabButton active={tab === 'characters'} onClick={() => setTab('characters')}>👥 Personajes</TabButton>
              <TabButton active={tab === 'combat'} onClick={() => setTab('combat')}>⚔️ Combate</TabButton>
              <TabButton active={tab === 'camp'} onClick={() => setTab('camp')}>🏕️ Campamento</TabButton>
              <TabButton active={tab === 'inventory'} onClick={() => setTab('inventory')}>🎒 Inventario</TabButton>
              <TabButton active={tab === 'dice'} onClick={() => setTab('dice')}>🎲 Dados</TabButton>
              <TabButton active={tab === 'log'} onClick={() => setTab('log')}>📜 Registro</TabButton>
            </div>
          </div>
        </div>
      </header>
  ...
  function ResourceBar() {
    ...
    return (
      <div className={`flex gap-3 text-sm px-3 py-1 rounded-lg ${criticalResources ? 'bg-red-950 border border-red-800' : 'bg-neutral-900 border border-neutral-800'}`}>
...
<div className="grid md:grid-cols-2 gap-4">
  <div className="p-4 rounded-2xl border border-purple-800 bg-purple-950/20">
    <h4 className="font-bold text-purple-300 mb-2">🎴 Mazo de Decisiones</h4>
    <div className="flex gap-2">
      <button onClick={drawStoryFromDeck} className="px-4 py-2 bg-purple-900 hover:bg-purple-800 rounded-lg">Robar</button>
      <button onClick={shuffleStoryDeck} className="px-4 py-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg">Barajar</button>
      <button onClick={reintegrateStoryDiscards} className="px-4 py-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg">Reintegrar descartes</button>
    </div>
  </div>
  <div className="p-4 rounded-2xl border border-red-800 bg-red-950/20">
    ...
    <div className="flex gap-2">
      <button onClick={drawCombatCard} className="px-4 py-2 bg-red-900 hover:bg-red-800 rounded-lg">Robar</button>
      <button onClick={shuffleCombatDeck} className="px-4 py-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg">Barajar</button>
      <button onClick={reintegrateCombatDiscards} className="px-4 py-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg">Reintegrar descartes</button>
      <button onClick={() => { nextTurn(); pushLog('Pasas el turno.', 'info'); }} className="ml-auto px-4 py-2 bg-neutral-800 hover:bg-neutral-700 rounded-lg">Pasar turno</button>
    </div>
  </div>
</div>
...
{currentStoryCard ? (
  <div className="bg-gradient-to-br from-purple-900/20 via-neutral-950 to-black border-2 border-purple-900 rounded-3xl p-8 shadow-2xl animate-fade-in">
    ...
    <p className="text-neutral-300 leading-relaxed text-lg mb-6 italic">{currentStoryCard.text}</p>
    {currentStoryCard.philosophy && philosophyQuotes[currentStoryCard.philosophy] && (
    ...
    <div className="grid md:grid-cols-3 gap-4">
      {currentStoryCard.choices.map((choice, idx) => (
        <button key={idx} onClick={() => handleStoryChoice(choice)} className="group p-5 bg-gradient-to-br from-neutral-900 to-neutral-950 hover:from-purple-950 hover:to-neutral-950 border border-neutral-700 hover:border-purple-700 rounded-xl transition-all text-left transform hover:scale-105">
          <span className="text-lg font-semibold group-hover:text-purple-300 transition-colors">→ {choice.text}</span>
          {choice.effect.karma && (<div className="mt-2 text-xs text-neutral-500">Karma: {choice.effect.karma > 0 ? '+' : ''}{choice.effect.karma}</div>)}
        </button>
      ))}
    </div>
  </div>
  ...
  <div className="bg-gradient-to-br from-red-900/20 via-neutral-950 to-black border-2 border-red-900 rounded-3xl p-8 shadow-2xl animate-fade-in">
    <div className="flex justify-between items-start mb-4">
      ...
      <span className="px-3 py-1 bg-red-900/30 text-red-400 rounded-full text-xs">⚔️ combate</span>
    </div>
    <p className="text-neutral-300 leading-relaxed text-lg mb-6 italic">{currentCombatCard.text}</p>
    <div className="grid md:grid-cols-3 gap-4">
      {currentCombatCard.choices.map((choice, idx) => (
        <button key={idx} onClick={() => handleCombatCardChoice(choice)} className="group p-5 bg-gradient-to-br from-neutral-900 to-neutral-950 hover:from-red-950 hover:to-neutral-950 border border-neutral-700 hover:border-red-700 rounded-xl transition-all text-left transform hover:scale-105">
          <span className="text-lg font-semibold group-hover:text-red-300 transition-colors">→ {choice.text}</span>
        </button>
      ))}
    </div>
  </div>
  ...
  <div className="text-center py-16 bg-gradient-to-br from-neutral-900 to-black rounded-3xl border border-neutral-800">
    <p className="text-xl text-neutral-400 mb-6">El destino aguarda tu próxima decisión o combate...</p>
    <div className="flex gap-4 justify-center">
      <button onClick={drawStoryFromDeck} className="px-8 py-4 bg-gradient-to-r from-purple-800 to-purple-900 hover:from-purple-700 hover:to-purple-800 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-xl">
        🎴 Robar Decisión
      </button>
      <button onClick={drawCombatCard} className="px-8 py-4 bg-gradient-to-r from-red-800 to-red-900 hover:from-red-700 hover:to-red-800 rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-xl">
        ⚔️ Robar Combate
      </button>
    </div>
  </div>
          ...
          <div className="bg-gradient-to-br from-neutral-900 via-neutral-950 to-black border-2 border-red-900 rounded-3xl p-8 shadow-2xl animate-fade-in">
            <div className="flex justify-between items-start mb-4">
            ...
            <p className="text-neutral-300 leading-relaxed text-lg mb-8 italic">
  ...
  function MoraleIndicator() {
    ...
    const moraleColor = morale > 70 ? 'from-green-600 to-green-400' : morale > 40 ? 'from-yellow-600 to-yellow-400' : 'from-red-600 to-red-400';
    ...
    return (
      <div className="bg-neutral-900 rounded-2xl p-6 border border-neutral-800">
        ...
        <p className="text-sm text-neutral-400 mt-2">
          {morale > 70 ? 'El grupo mantiene la esperanza' : 
           morale > 40 ? 'Las tensiones aumentan' : 
    ...
    return (
      <div className="grid md:grid-cols-3 gap-4">
        {players.map((player, idx) => (
          <div key={player.id} className={`relative p-5 rounded-2xl border-2 transition-all ${
            idx === activeIndex 
            ...
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <p className="text-sm text-neutral-400">{player.profesión} • Nivel {player.nivel}</p>
              </div>
  ...
  function StatusIndicator({ estado }) {
    ...
    return (
      <span className={`px-2 py-1 rounded-full text-xs ${estados[estado].color} text-white`}>
        {estados[estado].text}
      </span>
    );
  }
  ...
  function HealthBar({ current, max }) {
    ...
    const color = percentage > 60 ? 'from-green-600 to-green-400' : 
                  percentage > 30 ? 'from-yellow-600 to-yellow-400' : 
    ...
    return (
      <div 
        ...
        className={`p-4 rounded-xl border-2 cursor-pointer transition-all ${
          selected ? 'border-red-600 bg-red-950/30' :
          active ? 'border-yellow-600 bg-yellow-950/20' :
          player.estado === 'muerto' ? 'border-neutral-900 bg-neutral-950 opacity-50' :
    ...
    return (
      <div className="bg-gradient-to-br from-red-950/30 to-black border-2 border-red-800 rounded-2xl p-6">
        ...
        <div className="mb-4 p-4 bg-neutral-900 rounded-xl border border-neutral-800">
          ...
          <p className="text-sm">DEF {actor.defensa} • PV {actor.pv}/{actor.pvMax}</p>
        </div>
          ...
          <div className="h-3 bg-neutral-800 rounded-full overflow-hidden">
            <div 
              className={`h-full transition-all ${
                hpPercentage > 60 ? 'bg-gradient-to-r from-green-600 to-green-400' :
                hpPercentage > 30 ? 'bg-gradient-to-r from-yellow-600 to-yellow-400' :
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4">
        ...
        <div className="mt-4 p-3 bg-neutral-800 rounded-lg text-sm">
          <div className="flex justify-between">
            <span>Munición:</span>
            <span className={!hasAmmo ? 'text-red-400' : ''}>{actor.munición}</span>
          </div>
          <div className="flex justify-between mt-1">
            <span>Energía:</span>
            <span className={actor.energía < 3 ? 'text-yellow-400' : ''}>{actor.energía}/{actor.energíaMax}</span>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div>
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-xl font-bold">{value}/{max}</span>
        </div>
        <div className="h-3 bg-neutral-800 rounded-full overflow-hidden">
          <div 
            className="h-full bg-gradient-to-r from-blue-600 to-blue-400 transition-all"
      ...
      <div className="bg-gradient-to-br from-neutral-900 to-black border border-neutral-800 rounded-2xl p-6">
        ...
        <div className="mt-6 p-4 bg-yellow-900/20 border border-yellow-800 rounded-xl">
          <p className="text-sm text-yellow-400">
            💡 Consejo: Mantén las defensas altas para reducir los ataques nocturnos
          </p>
        </div>
      </div>
    );
        ...
        <div className="flex justify-between items-start">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg transition-all ${
              canAfford ? 'bg-blue-900 hover:bg-blue-800' : 'bg-neutral-800 cursor-not-allowed'
            }`}
          >
            Construir
          </button>
            ...
            <div className="space-y-1 text-sm">
              <div className="flex justify-between">
                ...
                <span className={resources.food < 5 ? 'text-red-400 font-bold' : ''}>
                  {Math.floor(resources.food / players.filter(p => p.estado !== 'muerto').length)} días
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-neutral-400">Con agua actual:</span>
                <span className={resources.water < 5 ? 'text-red-400 font-bold' : ''}>
                  {Math.floor(resources.water / players.filter(p => p.estado !== 'muerto').length)} días
                </span>
              </div>
            </div>
          </div>
  ...
  function ResourceCard({ type, value }) {
    ...
    return (
      <div className={`p-4 rounded-xl text-center ${critical ? 'bg-red-950 border border-red-800 animate-pulse' : 'bg-neutral-800'}`}>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <button 
                    onClick={() => {
                      if (resources.ammo > 0) {
                        updatePlayer(players.indexOf(player), { munición: player.munición + 10 });
          ...
          <div className="mb-4 space-y-3">
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <button onClick={() => setModifier(prev => prev - 1)} className="px-3 py-2 bg-neutral-800 rounded">-</button>
                <input
                  type="number"
                  value={modifier}
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-1">
                <button onClick={() => performRoll(3, 6)} className="px-3 py-2 bg-neutral-800 hover:bg-neutral-700 rounded">3d6</button>
                <button onClick={() => performRoll(2, 10)} className="px-3 py-2 bg-neutral-800 hover:bg-neutral-700 rounded">2d10</button>
                <button onClick={() => performRoll(4, 6)} className="px-3 py-2 bg-neutral-800 hover:bg-neutral-700 rounded">4d6</button>
              </div>
            </div>
          </div>
        )}
  ...
  function LogTab() {
    ...
    const filteredLog = filter === 'all' ? log : log.filter(entry => {
  ...
  function LogEntry({ entry }) {
    ...
    return (
      <div className={`text-sm p-3 rounded-lg border animate-fade-in ${getEntryStyle()}`}>
        {entry}
      </div>
    );
  }
          ...
          <div className="bg-black/50 rounded-2xl p-8 max-w-2xl mx-auto mb-8">
            ...
            <div className="mt-6 pt-6 border-t border-neutral-800">
              <p className="text-neutral-400 italic">
                {karma > 50 ? "Tu bondad será recordada en las leyendas" :
                 karma < -50 ? "Sobreviviste, pero a qué costo..." :
